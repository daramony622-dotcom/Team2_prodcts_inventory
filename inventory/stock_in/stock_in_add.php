...
<section class="space-y-6">
    <div class="bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-3xl px-6 py-8 shadow-lg">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <a href="index.php"
                class="inline-flex items-center justify-center bg-white text-slate-700 font-semibold px-4 py-2.5 rounded-xl shadow-sm hover:bg-emerald-50 transition">
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
        <div class="p-6 md:p-8">
            <form action="save.php" method="POST" class="space-y-4">
                <div>
                    <label for="product_id" class="block mb-1 text-sm font-semibold text-slate-700">Select
                        Product</label>
                    <select name="product_id" id="product_id"
                        class="w-full border border-slate-300 rounded-xl px-3 py-2.5 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none"
                        required>
                ...
                <div>
                    <label for="purchase_price" class="block mb-1 text-sm font-semibold text-slate-700">Purchase Price
                        ($)</label>
                ...
                <div>
                    <label for="stock_in_date" class="block mb-1 text-sm font-semibold text-slate-700">Stock In
                        Date</label>
                ...
                <div class="pt-2">
                    <button type="submit"
                        class="w-full bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-3 rounded-xl font-semibold shadow-sm transition">Save
                        Stock In</button>
                </div>
            </form>
        </div>
